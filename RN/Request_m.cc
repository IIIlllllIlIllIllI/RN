...
RequestDescriptor::RequestDescriptor() : omnetpp::cClassDescriptor("Request", "omnetpp::cPacket")
{
...
std::string RequestDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Request *pp = (Request *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getHostname(i));
        default: return "";
    }
}
...
bool RequestDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Request *pp = (Request *)object; (void)pp;
    switch (field) {
        case 0: pp->setHostname(i,string2long(value)); return true;
