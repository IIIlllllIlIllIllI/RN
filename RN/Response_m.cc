...
Response::Response(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
...
Response::Response(const Response& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
{
    for (unsigned int i=0; i<8; i++)
        this->statuscode[i] = other.statuscode[i];
...
void Response::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimArrayPacking(b,this->statuscode,8);
...
void Response::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimArrayUnpacking(b,this->statuscode,8);
    doParsimUnpacking(b,this->address);
}

unsigned int Response::getStatuscodeArraySize() const
{
    return 8;
}

char Response::getStatuscode(unsigned int k) const
{
    if (k>=8) throw omnetpp::cRuntimeError("Array of size 8 indexed by %lu", (unsigned long)k);
    return this->statuscode[k];
}

void Response::setStatuscode(unsigned int k, char statuscode)
{
    if (k>=8) throw omnetpp::cRuntimeError("Array of size 8 indexed by %lu", (unsigned long)k);
...
ResponseDescriptor::ResponseDescriptor() : omnetpp::cClassDescriptor("Response", "omnetpp::cPacket")
{
...
int ResponseDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *ResponseDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string ResponseDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool ResponseDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *ResponseDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
