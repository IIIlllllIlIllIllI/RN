//
// Generated file, do not edit! Created by nedtool 5.2 from src/udp/UDPControlInfo.msg.
//
...
inet::IPv4Address& UDPControlInfo::getSrcIP()
{
    return this->srcIP;
}

void UDPControlInfo::setSrcIP(const inet::IPv4Address& srcIP)
{
    this->srcIP = srcIP;
}
...
inet::IPv4Address& UDPControlInfo::getDestIP()
{
    return this->destIP;
}

void UDPControlInfo::setDestIP(const inet::IPv4Address& destIP)
{
    this->destIP = destIP;
}
...
int UDPControlInfoDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "srcPort")==0) return base+1;
...
std::string UDPControlInfoDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getSrcPort());
...
bool UDPControlInfoDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    UDPControlInfo *pp = (UDPControlInfo *)object; (void)pp;
    switch (field) {
        case 1: pp->setSrcPort(string2long(value)); return true;
